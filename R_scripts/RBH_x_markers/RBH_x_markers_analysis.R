...
Clytia_larva_Nematostella_larva_o <- read.csv('/Users/mmeynadier/Documents/PhD/scripts/GD_ECT_Cnidaria/py_scripts/RBH_x_markers/results/stat/Clytia_larva_Nematostella_larva_Fisher_test_1000g_orthopairsBased.csv')
Clytia_larva_Nematostella_larva_o <- Clytia_larva_Nematostella_larva_o[-c(1)]
Clytia_larva_Nematostella_larva_g <- read.csv('/Users/mmeynadier/Documents/PhD/scripts/GD_ECT_Cnidaria/py_scripts/RBH_x_markers/results/stat/Clytia_larva_Nematostella_larva_Fisher_test_1000g_genomeBased.csv')
Clytia_larva_Nematostella_larva_g <- Clytia_larva_Nematostella_larva_g[-c(1)]
...
Clytia_adult_Nematostella_adult_g <- read.csv('/Users/mmeynadier/Documents/PhD/scripts/GD_ECT_Cnidaria/py_scripts/RBH_x_markers/results/stat/Clytia_adult_Nematostella_adult_Fisher_test_1000g_genomeBased.csv')
Clytia_adult_Nematostella_adult_g <- Clytia_adult_Nematostella_adult_g[-c(1)]
Clytia_adult_Nematostella_adult_o <- read.csv('/Users/mmeynadier/Documents/PhD/scripts/GD_ECT_Cnidaria/py_scripts/RBH_x_markers/results/stat/Clytia_adult_Nematostella_adult_Fisher_test_1000g_orthopairsBased.csv')
Clytia_adult_Nematostella_adult_o <- Clytia_adult_Nematostella_adult_o[-c(1)]
...
row.names(Clytia_larva_Nematostella_larva_o) <- Clytia_larva
colnames(Clytia_larva_Nematostella_larva_o) <- Nematostella_larva
row.names(Clytia_larva_Nematostella_larva_g) <- Clytia_larva
colnames(Clytia_larva_Nematostella_larva_g) <- Nematostella_larva
...
row.names(Clytia_adult_Nematostella_adult_o) <- Clytia_adult
colnames(Clytia_adult_Nematostella_adult_o) <- Nematostella_adult
row.names(Clytia_adult_Nematostella_adult_g) <- Clytia_adult
colnames(Clytia_adult_Nematostella_adult_g) <- Nematostella_adult
...
# pheatmap
transform_Clytia_larva_Nematostella_larva_fisher_matrix_o<--log10(as.matrix(Clytia_larva_Nematostella_larva_o))
transform_Clytia_larva_Nematostella_larva_fisher_matrix_o<-matrix(unlist(transform_Clytia_larva_Nematostella_larva_fisher_matrix_o),ncol=21)
row.names(transform_Clytia_larva_Nematostella_larva_fisher_matrix_o) <- Clytia_larva
colnames(transform_Clytia_larva_Nematostella_larva_fisher_matrix_o) <- Nematostella_larva

setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(transform_Clytia_larva_Nematostella_larva_fisher_matrix_o,cluster_rows = F, cluster_cols = F,main="Adult fisher exact test")
setHook("grid.newpage", NULL, "replace")
grid.text("Nematostella larva", y=-0.07, gp=gpar(fontsize=14))
grid.text("Clytia larva", x=-0.07, rot=90, gp=gpar(fontsize=14))


transform_Clytia_larva_Nematostella_larva_fisher_matrix_g<--log10(as.matrix(Clytia_larva_Nematostella_larva_g))
transform_Clytia_larva_Nematostella_larva_fisher_matrix_g<-matrix(unlist(transform_Clytia_larva_Nematostella_larva_fisher_matrix_g),ncol=21)
row.names(transform_Clytia_larva_Nematostella_larva_fisher_matrix_g) <- Clytia_larva
colnames(transform_Clytia_larva_Nematostella_larva_fisher_matrix_g) <- Nematostella_larva

setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(transform_Clytia_larva_Nematostella_larva_fisher_matrix_g,cluster_rows = F, cluster_cols = F,main="Adult fisher exact test")
setHook("grid.newpage", NULL, "replace")
grid.text("Nematostella larva", y=-0.07, gp=gpar(fontsize=14))
grid.text("Clytia larva", x=-0.07, rot=90, gp=gpar(fontsize=14))
...
transform_Clytia_adult_Nematostella_adult_fisher_matrix_o<--log10(as.matrix(Clytia_adult_Nematostella_adult_o))
transform_Clytia_adult_Nematostella_adult_fisher_matrix_o<-matrix(unlist(transform_Clytia_adult_Nematostella_adult_fisher_matrix_o),ncol=22)
row.names(transform_Clytia_adult_Nematostella_adult_fisher_matrix_o) <- Clytia_adult
colnames(transform_Clytia_adult_Nematostella_adult_fisher_matrix_o) <- Nematostella_adult

setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(t(transform_Clytia_adult_Nematostella_adult_fisher_matrix_o),cluster_rows = F, cluster_cols = F,main="Adult fisher exact test")
setHook("grid.newpage", NULL, "replace")
grid.text("Clytia adult", y=-0.07, gp=gpar(fontsize=14))
grid.text("Nematostella adult", x=-0.07, rot=90, gp=gpar(fontsize=14))


transform_Clytia_adult_Nematostella_adult_fisher_matrix_g<--log10(as.matrix(Clytia_adult_Nematostella_adult_g))
transform_Clytia_adult_Nematostella_adult_fisher_matrix_g<-matrix(unlist(transform_Clytia_adult_Nematostella_adult_fisher_matrix_g),ncol=22)
row.names(transform_Clytia_adult_Nematostella_adult_fisher_matrix_g) <- Clytia_adult
colnames(transform_Clytia_adult_Nematostella_adult_fisher_matrix_g) <- Nematostella_adult

setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(t(transform_Clytia_adult_Nematostella_adult_fisher_matrix_g),cluster_rows = F, cluster_cols = F,main="Adult fisher exact test")
setHook("grid.newpage", NULL, "replace")
grid.text("Clytia adult", y=-0.07, gp=gpar(fontsize=14))
grid.text("Nematostella adult", x=-0.07, rot=90, gp=gpar(fontsize=14))
...
setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(Clytia_larva_Nematostella_larva,main="Bootstrap test",breaks=bootstrapBreaks,color=bootstrapColorsBreak)
setHook("grid.newpage", NULL, "replace")
grid.text("Nematostella larva", y=-0.07, gp=gpar(fontsize=14))
grid.text("Clytia larva", x=-0.07, rot=90, gp=gpar(fontsize=14))
...
setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(Clytia_larva_Nematostella_adult,main="Bootstrap test",breaks=bootstrapBreaks,color=bootstrapColorsBreak)
setHook("grid.newpage", NULL, "replace")
...
setHook("grid.newpage", function() pushViewport(viewport(x=1,y=1,width=0.9, height=0.9, name="vp", just=c("right","top"))), action="prepend")
pheatmap(Nematostella_larva_Xenia_adult_bootstrap,main="Bootstrap test",breaks=bootstrapBreaks,color=bootstrapColorsBreak)
setHook("grid.newpage", NULL, "replace")
grid.text("Xenia adult", y=-0.07, gp=gpar(fontsize=14))
grid.text("Nematostella larva", x=-0.07, rot=90, gp=gpar(fontsize=14))
...
# Same species
Clytia_larva_Clytia_adult <- read.csv('Clytia/analysis/RBH_x_markers/stat/Clytia_larva_Clytia_adult_Fisher_test_1000g_NEW_METHOD_Clytia.csv')
Clytia_larva_Clytia_adult <- Clytia_larva_Clytia_adult[-c(1)]



Clytia_larva_Nematostella_larva_o <- read.csv('/Users/mmeynadier/Documents/PhD/scripts/GD_ECT_Cnidaria/py_scripts/RBH_x_markers/results/stat/Clytia_adult_Clytia_larva_Fisher_test_1000g_genomeBased.csv')
...
# Label columns and rows
row.names(Clytia_larva_Clytia_adult) <- Clytia_adult
colnames(Clytia_larva_Clytia_adult) <- Clytia_larva
...
transform_Clytia_larva_Clytia_adult_fisher_matrix<-matrix(unlist(transform_Clytia_larva_Clytia_adult_fisher_matrix),ncol=19)
...
row.names(transform_Clytia_larva_Clytia_adult_fisher_matrix) <- Clytia_adult
colnames(transform_Clytia_larva_Clytia_adult_fisher_matrix) <- Clytia_larva
