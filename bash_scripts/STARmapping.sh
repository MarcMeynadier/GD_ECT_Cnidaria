...
STAR --runThreadN 16 --soloBarcodeReadLength $soloBarcodeReadLength --soloCellFilter EmptyDrops_CR --readFilesCommand zcat --genomeDir $genomeDir --readFilesIn $readFilesIn --soloType $SOLOTYPE --soloCBwhitelist $soloCBwhitelist
